...
const MOCK: RawMaterialRow[] = [
  { id: 'm1', code: '#00001', gradeId: 'g1', profileId: 'p1', dimensions: { diameter: 50 }, lengthMm: '2000', currentStock: '3', minStock: '2', photoPath: null, weightKg: 30.84, createdAt: '2026-01-10T08:00:00Z', updatedAt: '2026-01-10T08:00:00Z', grade: { id: 'g1', name: 'S355', densityKgM3: '7850', createdAt: '' }, profile: { id: 'p1', name: 'Rond', dimensionSchema: [], volumeFormula: 'round', createdAt: '' }, locationSlot: { id: 's1', level1: 'R1', level2: null, location: { id: 'l1', kind: 'rack', label: 'Rack A' } } },
  { id: 'm2', code: '#00002', gradeId: 'g1', profileId: 'p1', dimensions: { diameter: 30 }, lengthMm: '1500', currentStock: '5', minStock: null, photoPath: null, weightKg: 8.31, createdAt: '2026-01-11T08:00:00Z', updatedAt: '2026-01-11T08:00:00Z', grade: { id: 'g1', name: 'S355', densityKgM3: '7850', createdAt: '' }, profile: { id: 'p1', name: 'Rond', dimensionSchema: [], volumeFormula: 'round', createdAt: '' }, locationSlot: { id: 's2', level1: 'R2', level2: null, location: { id: 'l1', kind: 'rack', label: 'Rack A' } } },
  { id: 'm3', code: '#00003', gradeId: 'g2', profileId: 'p2', dimensions: { width: 40, height: 10 }, lengthMm: '3000', currentStock: '2', minStock: null, photoPath: null, weightKg: 9.42, createdAt: '2026-01-12T08:00:00Z', updatedAt: '2026-01-12T08:00:00Z', grade: { id: 'g2', name: 'S235', densityKgM3: '7850', createdAt: '' }, profile: { id: 'p2', name: 'Plat', dimensionSchema: [], volumeFormula: 'flat', createdAt: '' }, locationSlot: { id: 's3', level1: 'R3', level2: null, location: { id: 'l2', kind: 'rack', label: 'Rack B' } } },
  { id: 'm4', code: '#00004', gradeId: 'g1', profileId: 'p3', dimensions: { outerDiameter: 60.3, innerDiameter: 51.3 }, lengthMm: '2500', currentStock: '1', minStock: '1', photoPath: null, weightKg: 16.72, createdAt: '2026-01-13T08:00:00Z', updatedAt: '2026-01-13T08:00:00Z', grade: { id: 'g1', name: 'S355', densityKgM3: '7850', createdAt: '' }, profile: { id: 'p3', name: 'Buis', dimensionSchema: [], volumeFormula: 'tube', createdAt: '' }, locationSlot: { id: 's4', level1: 'R1', level2: 'V2', location: { id: 'l1', kind: 'rack', label: 'Rack A' } } },
  { id: 'm5', code: '#00005', gradeId: 'g1', profileId: 'p4', dimensions: { side: 25 }, lengthMm: '1000', currentStock: '8', minStock: '5', photoPath: null, weightKg: 4.91, createdAt: '2026-01-14T08:00:00Z', updatedAt: '2026-01-14T08:00:00Z', grade: { id: 'g1', name: 'S355', densityKgM3: '7850', createdAt: '' }, profile: { id: 'p4', name: 'Vierkant', dimensionSchema: [], volumeFormula: 'square', createdAt: '' }, locationSlot: { id: 's5', level1: 'R1', level2: null, location: { id: 'l2', kind: 'rack', label: 'Rack B' } } },
  { id: 'm6', code: '#00006', gradeId: 'g2', profileId: 'p1', dimensions: { diameter: 80 }, lengthMm: '500', currentStock: '1', minStock: null, photoPath: null, weightKg: 19.73, createdAt: '2026-01-15T08:00:00Z', updatedAt: '2026-01-15T08:00:00Z', grade: { id: 'g2', name: 'S235', densityKgM3: '7850', createdAt: '' }, profile: { id: 'p1', name: 'Rond', dimensionSchema: [], volumeFormula: 'round', createdAt: '' }, locationSlot: { id: 's6', level1: 'R3', level2: null, location: { id: 'l1', kind: 'rack', label: 'Rack A' } } },
  { id: 'm7', code: '#00007', gradeId: 'g2', profileId: 'p2', dimensions: { width: 60, height: 20 }, lengthMm: '2000', currentStock: '4', minStock: '2', photoPath: null, weightKg: 18.84, createdAt: '2026-01-16T08:00:00Z', updatedAt: '2026-01-16T08:00:00Z', grade: { id: 'g2', name: 'S235', densityKgM3: '7850', createdAt: '' }, profile: { id: 'p2', name: 'Plat', dimensionSchema: [], volumeFormula: 'flat', createdAt: '' }, locationSlot: { id: 's7', level1: 'R2', level2: null, location: { id: 'l2', kind: 'rack', label: 'Rack B' } } },
]
