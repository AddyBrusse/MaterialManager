...
function makeJob(overrides: Partial<QueueJob> & { orderId: string }): QueueJob {
  ...
  job.item = {
    ...
    order: { id: job.orderId, projectId: 'p', offerteRegelId: 'r', artikelId: null, artikelNaam: job.artikel, qty: 1, eenheid: 'stuks', aantalGereed: 0, stappen: [], status: 'gepland', createdAt: '', updatedAt: '' },
